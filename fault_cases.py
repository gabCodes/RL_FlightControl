...
# err_eff_roll3 = np.abs(fault_test("eff", "v2ROLL", 250, 10, REDQ=True, Q_nr=5, plot=True))
...
# # Your original groups dict with arrays (assumed numpy arrays or lists)
# groups = {
...
#     # Flatten and prepare a DataFrame for seaborn
#     dfs = []
